...
public class FavoriteServiceTest {
	...
	public void duplicateFavorite() {
		...
		Assertions.assertEquals(e.getMessage(), ErrorCode.ALREADY_EXIST_FAVORITE);
	...
	public void deleteFailFavorite() {
		...
		BasicException e = Assertions.assertThrows(BasicException.class,
			() -> favoriteService.deleteFavorite(1L, member));
		Assertions.assertEquals(e.getMessage(), ErrorCode.INVALID_PERMISSION_FAVORITE);
