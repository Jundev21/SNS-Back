...
import static com.sns.sns.service.data.UserData.*;
...
public class CommentServiceTest {
	...
	public void successToGetComment() throws Exception {
		...
		List<CommentGetResponse> result = commentService.getComment(1L);
	...
	public void deleteComment() throws Exception {
		...
		assertDoesNotThrow(() -> commentService.deleteComment(1L, member));
	}
	...
	public void deleteAuthComment() throws Exception {
		...
		assertThrows(BasicException.class, () -> commentService.deleteComment(1L, member));
	}
}
